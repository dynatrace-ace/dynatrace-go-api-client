...
func (r ApiGetProcessGroupsRequest) Execute() ([]ProcessGroup, *_nethttp.Response, error) {
 ...
 */
func (a *TopologySmartscapeProcessGroupApiService) GetProcessGroups(ctx _context.Context) ApiGetProcessGroupsRequest {
	return ApiGetProcessGroupsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (r ApiGetSingleProcessGroupRequest) Execute() (ProcessGroup, *_nethttp.Response, error) {
 ...
 */
func (a *TopologySmartscapeProcessGroupApiService) GetSingleProcessGroup(ctx _context.Context, meIdentifier string) ApiGetSingleProcessGroupRequest {
	return ApiGetSingleProcessGroupRequest{
		ApiService: a,
		ctx: ctx,
...
func (r ApiUpdateProcessGroupRequest) Execute() (*_nethttp.Response, error) {
