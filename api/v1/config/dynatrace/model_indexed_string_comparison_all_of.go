...
// IndexedStringComparisonAllOf struct for IndexedStringComparisonAllOf
type IndexedStringComparisonAllOf struct {
...
func NewIndexedStringComparisonAllOf() *IndexedStringComparisonAllOf {
	this := IndexedStringComparisonAllOf{}
	return &this
}
...
func (o IndexedStringComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableIndexedStringComparisonAllOf struct {
	value *IndexedStringComparisonAllOf
	isSet bool
}

func (v NullableIndexedStringComparisonAllOf) Get() *IndexedStringComparisonAllOf {
	return v.value
}

func (v *NullableIndexedStringComparisonAllOf) Set(val *IndexedStringComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIndexedStringComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIndexedStringComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndexedStringComparisonAllOf(val *IndexedStringComparisonAllOf) *NullableIndexedStringComparisonAllOf {
	return &NullableIndexedStringComparisonAllOf{value: val, isSet: true}
}

func (v NullableIndexedStringComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndexedStringComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
