...
// ZosComparisonInfoAllOf struct for ZosComparisonInfoAllOf
type ZosComparisonInfoAllOf struct {
...
func (o ZosComparisonInfoAllOf) MarshalJSON() ([]byte, error) {
...
type NullableZosComparisonInfoAllOf struct {
	value *ZosComparisonInfoAllOf
	isSet bool
}

func (v NullableZosComparisonInfoAllOf) Get() *ZosComparisonInfoAllOf {
	return v.value
}

func (v *NullableZosComparisonInfoAllOf) Set(val *ZosComparisonInfoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableZosComparisonInfoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableZosComparisonInfoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZosComparisonInfoAllOf(val *ZosComparisonInfoAllOf) *NullableZosComparisonInfoAllOf {
	return &NullableZosComparisonInfoAllOf{value: val, isSet: true}
}

func (v NullableZosComparisonInfoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZosComparisonInfoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
