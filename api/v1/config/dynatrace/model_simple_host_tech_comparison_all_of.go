...
// SimpleHostTechComparisonAllOf struct for SimpleHostTechComparisonAllOf
type SimpleHostTechComparisonAllOf struct {
...
func NewSimpleHostTechComparisonAllOf() *SimpleHostTechComparisonAllOf {
	this := SimpleHostTechComparisonAllOf{}
	return &this
}
...
func (o SimpleHostTechComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableSimpleHostTechComparisonAllOf struct {
	value *SimpleHostTechComparisonAllOf
	isSet bool
}

func (v NullableSimpleHostTechComparisonAllOf) Get() *SimpleHostTechComparisonAllOf {
	return v.value
}

func (v *NullableSimpleHostTechComparisonAllOf) Set(val *SimpleHostTechComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSimpleHostTechComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSimpleHostTechComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSimpleHostTechComparisonAllOf(val *SimpleHostTechComparisonAllOf) *NullableSimpleHostTechComparisonAllOf {
	return &NullableSimpleHostTechComparisonAllOf{value: val, isSet: true}
}

func (v NullableSimpleHostTechComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSimpleHostTechComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
