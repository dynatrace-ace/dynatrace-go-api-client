...
// AzureSkuComparisionAllOf struct for AzureSkuComparisionAllOf
type AzureSkuComparisionAllOf struct {
...
func (o AzureSkuComparisionAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAzureSkuComparisionAllOf struct {
	value *AzureSkuComparisionAllOf
	isSet bool
}

func (v NullableAzureSkuComparisionAllOf) Get() *AzureSkuComparisionAllOf {
	return v.value
}

func (v *NullableAzureSkuComparisionAllOf) Set(val *AzureSkuComparisionAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureSkuComparisionAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureSkuComparisionAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureSkuComparisionAllOf(val *AzureSkuComparisionAllOf) *NullableAzureSkuComparisionAllOf {
	return &NullableAzureSkuComparisionAllOf{value: val, isSet: true}
}

func (v NullableAzureSkuComparisionAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureSkuComparisionAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
