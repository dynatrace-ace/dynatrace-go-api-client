...
func (o EntityIdComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableEntityIdComparisonAllOf struct {
	value *EntityIdComparisonAllOf
	isSet bool
}

func (v NullableEntityIdComparisonAllOf) Get() *EntityIdComparisonAllOf {
	return v.value
}

func (v *NullableEntityIdComparisonAllOf) Set(val *EntityIdComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEntityIdComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEntityIdComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntityIdComparisonAllOf(val *EntityIdComparisonAllOf) *NullableEntityIdComparisonAllOf {
	return &NullableEntityIdComparisonAllOf{value: val, isSet: true}
}

func (v NullableEntityIdComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntityIdComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
