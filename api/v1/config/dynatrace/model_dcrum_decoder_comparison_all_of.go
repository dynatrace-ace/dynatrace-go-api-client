...
func NewDcrumDecoderComparisonAllOf() *DcrumDecoderComparisonAllOf {
	this := DcrumDecoderComparisonAllOf{}
	return &this
}
...
func (o DcrumDecoderComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableDcrumDecoderComparisonAllOf struct {
	value *DcrumDecoderComparisonAllOf
	isSet bool
}

func (v NullableDcrumDecoderComparisonAllOf) Get() *DcrumDecoderComparisonAllOf {
	return v.value
}

func (v *NullableDcrumDecoderComparisonAllOf) Set(val *DcrumDecoderComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableDcrumDecoderComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableDcrumDecoderComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcrumDecoderComparisonAllOf(val *DcrumDecoderComparisonAllOf) *NullableDcrumDecoderComparisonAllOf {
	return &NullableDcrumDecoderComparisonAllOf{value: val, isSet: true}
}

func (v NullableDcrumDecoderComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcrumDecoderComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
