...
// AzureComputeModeComparisonAllOf struct for AzureComputeModeComparisonAllOf
type AzureComputeModeComparisonAllOf struct {
...
func NewAzureComputeModeComparisonAllOf() *AzureComputeModeComparisonAllOf {
	this := AzureComputeModeComparisonAllOf{}
	return &this
}
...
func (o AzureComputeModeComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAzureComputeModeComparisonAllOf struct {
	value *AzureComputeModeComparisonAllOf
	isSet bool
}

func (v NullableAzureComputeModeComparisonAllOf) Get() *AzureComputeModeComparisonAllOf {
	return v.value
}

func (v *NullableAzureComputeModeComparisonAllOf) Set(val *AzureComputeModeComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureComputeModeComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureComputeModeComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureComputeModeComparisonAllOf(val *AzureComputeModeComparisonAllOf) *NullableAzureComputeModeComparisonAllOf {
	return &NullableAzureComputeModeComparisonAllOf{value: val, isSet: true}
}

func (v NullableAzureComputeModeComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureComputeModeComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
