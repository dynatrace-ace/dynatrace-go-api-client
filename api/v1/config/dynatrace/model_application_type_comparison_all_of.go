...
// ApplicationTypeComparisonAllOf struct for ApplicationTypeComparisonAllOf
type ApplicationTypeComparisonAllOf struct {
...
func NewApplicationTypeComparisonAllOf() *ApplicationTypeComparisonAllOf {
	this := ApplicationTypeComparisonAllOf{}
	return &this
}
...
func (o ApplicationTypeComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableApplicationTypeComparisonAllOf struct {
	value *ApplicationTypeComparisonAllOf
	isSet bool
}

func (v NullableApplicationTypeComparisonAllOf) Get() *ApplicationTypeComparisonAllOf {
	return v.value
}

func (v *NullableApplicationTypeComparisonAllOf) Set(val *ApplicationTypeComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationTypeComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationTypeComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationTypeComparisonAllOf(val *ApplicationTypeComparisonAllOf) *NullableApplicationTypeComparisonAllOf {
	return &NullableApplicationTypeComparisonAllOf{value: val, isSet: true}
}

func (v NullableApplicationTypeComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationTypeComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
