...
// ServiceTopologyComparisonAllOf struct for ServiceTopologyComparisonAllOf
type ServiceTopologyComparisonAllOf struct {
...
func NewServiceTopologyComparisonAllOf() *ServiceTopologyComparisonAllOf {
	this := ServiceTopologyComparisonAllOf{}
	return &this
}
...
func (o ServiceTopologyComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableServiceTopologyComparisonAllOf struct {
	value *ServiceTopologyComparisonAllOf
	isSet bool
}

func (v NullableServiceTopologyComparisonAllOf) Get() *ServiceTopologyComparisonAllOf {
	return v.value
}

func (v *NullableServiceTopologyComparisonAllOf) Set(val *ServiceTopologyComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceTopologyComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceTopologyComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceTopologyComparisonAllOf(val *ServiceTopologyComparisonAllOf) *NullableServiceTopologyComparisonAllOf {
	return &NullableServiceTopologyComparisonAllOf{value: val, isSet: true}
}

func (v NullableServiceTopologyComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceTopologyComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
