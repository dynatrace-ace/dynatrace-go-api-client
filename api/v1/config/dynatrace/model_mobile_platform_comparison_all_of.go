...
// MobilePlatformComparisonAllOf struct for MobilePlatformComparisonAllOf
type MobilePlatformComparisonAllOf struct {
...
func NewMobilePlatformComparisonAllOf() *MobilePlatformComparisonAllOf {
	this := MobilePlatformComparisonAllOf{}
	return &this
}
...
func (o MobilePlatformComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableMobilePlatformComparisonAllOf struct {
	value *MobilePlatformComparisonAllOf
	isSet bool
}

func (v NullableMobilePlatformComparisonAllOf) Get() *MobilePlatformComparisonAllOf {
	return v.value
}

func (v *NullableMobilePlatformComparisonAllOf) Set(val *MobilePlatformComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMobilePlatformComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMobilePlatformComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobilePlatformComparisonAllOf(val *MobilePlatformComparisonAllOf) *NullableMobilePlatformComparisonAllOf {
	return &NullableMobilePlatformComparisonAllOf{value: val, isSet: true}
}

func (v NullableMobilePlatformComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobilePlatformComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
