...
// HttpMethodComparisonInfoAllOf struct for HttpMethodComparisonInfoAllOf
type HttpMethodComparisonInfoAllOf struct {
...
func NewHttpMethodComparisonInfoAllOf() *HttpMethodComparisonInfoAllOf {
	this := HttpMethodComparisonInfoAllOf{}
	return &this
}
...
func (o HttpMethodComparisonInfoAllOf) MarshalJSON() ([]byte, error) {
...
type NullableHttpMethodComparisonInfoAllOf struct {
	value *HttpMethodComparisonInfoAllOf
	isSet bool
}

func (v NullableHttpMethodComparisonInfoAllOf) Get() *HttpMethodComparisonInfoAllOf {
	return v.value
}

func (v *NullableHttpMethodComparisonInfoAllOf) Set(val *HttpMethodComparisonInfoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpMethodComparisonInfoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpMethodComparisonInfoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpMethodComparisonInfoAllOf(val *HttpMethodComparisonInfoAllOf) *NullableHttpMethodComparisonInfoAllOf {
	return &NullableHttpMethodComparisonInfoAllOf{value: val, isSet: true}
}

func (v NullableHttpMethodComparisonInfoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHttpMethodComparisonInfoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
