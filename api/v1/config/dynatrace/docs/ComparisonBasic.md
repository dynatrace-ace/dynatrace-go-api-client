...
------------ | ------------- | ------------- | -------------
**Operator** | [**map[string]interface{}**](.md) | Operator of the comparison.   You can reverse it by setting **negate** to &#x60;true&#x60;.   Example: EQUALS, EXISTS   Example operators might not necessarily be available for the selected type | 
**Value** | [**map[string]interface{}**](.md) | The value to compare to. | [optional] 
