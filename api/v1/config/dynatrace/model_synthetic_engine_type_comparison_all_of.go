...
// SyntheticEngineTypeComparisonAllOf struct for SyntheticEngineTypeComparisonAllOf
type SyntheticEngineTypeComparisonAllOf struct {
...
func NewSyntheticEngineTypeComparisonAllOf() *SyntheticEngineTypeComparisonAllOf {
	this := SyntheticEngineTypeComparisonAllOf{}
	return &this
}
...
func (o SyntheticEngineTypeComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableSyntheticEngineTypeComparisonAllOf struct {
	value *SyntheticEngineTypeComparisonAllOf
	isSet bool
}

func (v NullableSyntheticEngineTypeComparisonAllOf) Get() *SyntheticEngineTypeComparisonAllOf {
	return v.value
}

func (v *NullableSyntheticEngineTypeComparisonAllOf) Set(val *SyntheticEngineTypeComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSyntheticEngineTypeComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSyntheticEngineTypeComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyntheticEngineTypeComparisonAllOf(val *SyntheticEngineTypeComparisonAllOf) *NullableSyntheticEngineTypeComparisonAllOf {
	return &NullableSyntheticEngineTypeComparisonAllOf{value: val, isSet: true}
}

func (v NullableSyntheticEngineTypeComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyntheticEngineTypeComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
