...
// OsTypeComparisonAllOf struct for OsTypeComparisonAllOf
type OsTypeComparisonAllOf struct {
...
func (o OsTypeComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableOsTypeComparisonAllOf struct {
	value *OsTypeComparisonAllOf
	isSet bool
}

func (v NullableOsTypeComparisonAllOf) Get() *OsTypeComparisonAllOf {
	return v.value
}

func (v *NullableOsTypeComparisonAllOf) Set(val *OsTypeComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableOsTypeComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableOsTypeComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOsTypeComparisonAllOf(val *OsTypeComparisonAllOf) *NullableOsTypeComparisonAllOf {
	return &NullableOsTypeComparisonAllOf{value: val, isSet: true}
}

func (v NullableOsTypeComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOsTypeComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
