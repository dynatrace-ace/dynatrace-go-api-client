...
// DatabaseTopologyComparisonAllOf struct for DatabaseTopologyComparisonAllOf
type DatabaseTopologyComparisonAllOf struct {
...
func NewDatabaseTopologyComparisonAllOf() *DatabaseTopologyComparisonAllOf {
	this := DatabaseTopologyComparisonAllOf{}
	return &this
}
...
func (o DatabaseTopologyComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableDatabaseTopologyComparisonAllOf struct {
	value *DatabaseTopologyComparisonAllOf
	isSet bool
}

func (v NullableDatabaseTopologyComparisonAllOf) Get() *DatabaseTopologyComparisonAllOf {
	return v.value
}

func (v *NullableDatabaseTopologyComparisonAllOf) Set(val *DatabaseTopologyComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableDatabaseTopologyComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableDatabaseTopologyComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatabaseTopologyComparisonAllOf(val *DatabaseTopologyComparisonAllOf) *NullableDatabaseTopologyComparisonAllOf {
	return &NullableDatabaseTopologyComparisonAllOf{value: val, isSet: true}
}

func (v NullableDatabaseTopologyComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatabaseTopologyComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
