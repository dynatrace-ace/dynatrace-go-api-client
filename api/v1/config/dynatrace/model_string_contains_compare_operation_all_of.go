...
func NewStringContainsCompareOperationAllOf() *StringContainsCompareOperationAllOf {
	this := StringContainsCompareOperationAllOf{}
	return &this
}
...
func (o StringContainsCompareOperationAllOf) MarshalJSON() ([]byte, error) {
...
type NullableStringContainsCompareOperationAllOf struct {
	value *StringContainsCompareOperationAllOf
	isSet bool
}

func (v NullableStringContainsCompareOperationAllOf) Get() *StringContainsCompareOperationAllOf {
	return v.value
}

func (v *NullableStringContainsCompareOperationAllOf) Set(val *StringContainsCompareOperationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStringContainsCompareOperationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStringContainsCompareOperationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStringContainsCompareOperationAllOf(val *StringContainsCompareOperationAllOf) *NullableStringContainsCompareOperationAllOf {
	return &NullableStringContainsCompareOperationAllOf{value: val, isSet: true}
}

func (v NullableStringContainsCompareOperationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStringContainsCompareOperationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
