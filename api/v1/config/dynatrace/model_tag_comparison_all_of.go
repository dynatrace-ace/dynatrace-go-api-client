...
// TagComparisonAllOf struct for TagComparisonAllOf
type TagComparisonAllOf struct {
...
func (o TagComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableTagComparisonAllOf struct {
	value *TagComparisonAllOf
	isSet bool
}

func (v NullableTagComparisonAllOf) Get() *TagComparisonAllOf {
	return v.value
}

func (v *NullableTagComparisonAllOf) Set(val *TagComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTagComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTagComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagComparisonAllOf(val *TagComparisonAllOf) *NullableTagComparisonAllOf {
	return &NullableTagComparisonAllOf{value: val, isSet: true}
}

func (v NullableTagComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
