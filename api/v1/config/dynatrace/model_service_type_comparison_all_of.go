...
// ServiceTypeComparisonAllOf struct for ServiceTypeComparisonAllOf
type ServiceTypeComparisonAllOf struct {
...
func NewServiceTypeComparisonAllOf() *ServiceTypeComparisonAllOf {
	this := ServiceTypeComparisonAllOf{}
	return &this
}
...
func (o ServiceTypeComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableServiceTypeComparisonAllOf struct {
	value *ServiceTypeComparisonAllOf
	isSet bool
}

func (v NullableServiceTypeComparisonAllOf) Get() *ServiceTypeComparisonAllOf {
	return v.value
}

func (v *NullableServiceTypeComparisonAllOf) Set(val *ServiceTypeComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceTypeComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceTypeComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceTypeComparisonAllOf(val *ServiceTypeComparisonAllOf) *NullableServiceTypeComparisonAllOf {
	return &NullableServiceTypeComparisonAllOf{value: val, isSet: true}
}

func (v NullableServiceTypeComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceTypeComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
