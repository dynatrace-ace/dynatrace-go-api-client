...
// CloudTypeComparisonAllOf struct for CloudTypeComparisonAllOf
type CloudTypeComparisonAllOf struct {
...
func (o CloudTypeComparisonAllOf) MarshalJSON() ([]byte, error) {
...
type NullableCloudTypeComparisonAllOf struct {
	value *CloudTypeComparisonAllOf
	isSet bool
}

func (v NullableCloudTypeComparisonAllOf) Get() *CloudTypeComparisonAllOf {
	return v.value
}

func (v *NullableCloudTypeComparisonAllOf) Set(val *CloudTypeComparisonAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTypeComparisonAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTypeComparisonAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTypeComparisonAllOf(val *CloudTypeComparisonAllOf) *NullableCloudTypeComparisonAllOf {
	return &NullableCloudTypeComparisonAllOf{value: val, isSet: true}
}

func (v NullableCloudTypeComparisonAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTypeComparisonAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
