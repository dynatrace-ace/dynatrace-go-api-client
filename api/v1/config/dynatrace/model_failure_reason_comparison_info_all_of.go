...
// FailureReasonComparisonInfoAllOf struct for FailureReasonComparisonInfoAllOf
type FailureReasonComparisonInfoAllOf struct {
...
func NewFailureReasonComparisonInfoAllOf() *FailureReasonComparisonInfoAllOf {
	this := FailureReasonComparisonInfoAllOf{}
	return &this
}
...
func (o FailureReasonComparisonInfoAllOf) MarshalJSON() ([]byte, error) {
...
type NullableFailureReasonComparisonInfoAllOf struct {
	value *FailureReasonComparisonInfoAllOf
	isSet bool
}

func (v NullableFailureReasonComparisonInfoAllOf) Get() *FailureReasonComparisonInfoAllOf {
	return v.value
}

func (v *NullableFailureReasonComparisonInfoAllOf) Set(val *FailureReasonComparisonInfoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFailureReasonComparisonInfoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFailureReasonComparisonInfoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFailureReasonComparisonInfoAllOf(val *FailureReasonComparisonInfoAllOf) *NullableFailureReasonComparisonInfoAllOf {
	return &NullableFailureReasonComparisonInfoAllOf{value: val, isSet: true}
}

func (v NullableFailureReasonComparisonInfoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFailureReasonComparisonInfoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
