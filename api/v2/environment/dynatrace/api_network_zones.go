...
func (r ApiGetNetworkZoneSettingsRequest) Execute() (NetworkZoneSettings, *_nethttp.Response, error) {
	return r.ApiService.GetNetworkZoneSettingsExecute(r)
}

/*
 * GetNetworkZoneSettings Gets the global configuration of network zones | maturity=EARLY_ADOPTER
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiGetNetworkZoneSettingsRequest
 */
func (a *NetworkZonesApiService) GetNetworkZoneSettings(ctx _context.Context) ApiGetNetworkZoneSettingsRequest {
	return ApiGetNetworkZoneSettingsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *NetworkZonesApiService) GetNetworkZoneSettingsExecute(r ApiGetNetworkZoneSettingsRequest) (NetworkZoneSettings, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiUpdateNetworkZoneSettingsRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.UpdateNetworkZoneSettingsExecute(r)
}

/*
 * UpdateNetworkZoneSettings Updates the global configuration of network zones | maturity=EARLY_ADOPTER
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiUpdateNetworkZoneSettingsRequest
 */
func (a *NetworkZonesApiService) UpdateNetworkZoneSettings(ctx _context.Context) ApiUpdateNetworkZoneSettingsRequest {
	return ApiUpdateNetworkZoneSettingsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * Execute executes the request
 */
func (a *NetworkZonesApiService) UpdateNetworkZoneSettingsExecute(r ApiUpdateNetworkZoneSettingsRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
