...
// DemUnitsQuota DEM units consumption and quota information on environment level. Not set (and not editable) if DEM units is not enabled. If skipped when editing via PUT method then already set quotas will remain.
type DemUnitsQuota struct {
...
func (o DemUnitsQuota) MarshalJSON() ([]byte, error) {
...
type NullableDemUnitsQuota struct {
	value *DemUnitsQuota
	isSet bool
}

func (v NullableDemUnitsQuota) Get() *DemUnitsQuota {
	return v.value
}

func (v *NullableDemUnitsQuota) Set(val *DemUnitsQuota) {
	v.value = val
	v.isSet = true
}

func (v NullableDemUnitsQuota) IsSet() bool {
	return v.isSet
}

func (v *NullableDemUnitsQuota) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDemUnitsQuota(val *DemUnitsQuota) *NullableDemUnitsQuota {
	return &NullableDemUnitsQuota{value: val, isSet: true}
}

func (v NullableDemUnitsQuota) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDemUnitsQuota) UnmarshalJSON(src []byte) error {
	v.isSet = true
