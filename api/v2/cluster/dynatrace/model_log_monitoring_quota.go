...
// LogMonitoringQuota Log monitoring consumption and quota information on environment level. Not set (and not editable) if Log monitoring is not enabled. Not set (and not editable) if Log monitoring is migrated to Davis data on license level. If skipped when editing via PUT method then already set quotas will remain.
type LogMonitoringQuota struct {
...
func (o LogMonitoringQuota) MarshalJSON() ([]byte, error) {
...
type NullableLogMonitoringQuota struct {
	value *LogMonitoringQuota
	isSet bool
}

func (v NullableLogMonitoringQuota) Get() *LogMonitoringQuota {
	return v.value
}

func (v *NullableLogMonitoringQuota) Set(val *LogMonitoringQuota) {
	v.value = val
	v.isSet = true
}

func (v NullableLogMonitoringQuota) IsSet() bool {
	return v.isSet
}

func (v *NullableLogMonitoringQuota) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogMonitoringQuota(val *LogMonitoringQuota) *NullableLogMonitoringQuota {
	return &NullableLogMonitoringQuota{value: val, isSet: true}
}

func (v NullableLogMonitoringQuota) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogMonitoringQuota) UnmarshalJSON(src []byte) error {
	v.isSet = true
