...
// SessionReplayRetention Session replay retention settings on environment level. Can be set to any value from 1 to 35 days. If skipped when editing via PUT method then already set limit will remain.
type SessionReplayRetention struct {
...
func (o SessionReplayRetention) MarshalJSON() ([]byte, error) {
...
type NullableSessionReplayRetention struct {
	value *SessionReplayRetention
	isSet bool
}

func (v NullableSessionReplayRetention) Get() *SessionReplayRetention {
	return v.value
}

func (v *NullableSessionReplayRetention) Set(val *SessionReplayRetention) {
	v.value = val
	v.isSet = true
}

func (v NullableSessionReplayRetention) IsSet() bool {
	return v.isSet
}

func (v *NullableSessionReplayRetention) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSessionReplayRetention(val *SessionReplayRetention) *NullableSessionReplayRetention {
	return &NullableSessionReplayRetention{value: val, isSet: true}
}

func (v NullableSessionReplayRetention) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSessionReplayRetention) UnmarshalJSON(src []byte) error {
	v.isSet = true
